...
const COLOR_OPTIONS = ['#10b981', '#6366f1', '#f59e0b', '#06b6d4', '#ec4899', '#ef4444', '#8b5cf6', '#f97316', '#14b8a6', '#a855f7'];
...
const AddHabitModal: React.FC<AddHabitModalProps> = ({ isOpen, onClose, weekStart }) => {
