...
const WeeklyTab: React.FC = () => {
  ...
  const weeklyHabits = habits.filter((h) =>
    h.activeWeeks?.includes(currentWeekStart),
  );
  const { pct, completed, total } = getWeeklyCompletion(
    weeklyHabits,
    currentWeek,
  );
  ...
  const lastWeekHabits = habits.filter((h) =>
    h.activeWeeks?.includes(lastWeekStart),
  );
    ...
    <div className="tab-content">
      ...
      <div className="week-nav">
        ...
        <div className="week-nav-center">
          ...
          {!isCurrentWeek && (
            <button className="btn-link" onClick={goToday}>
              ↩ This Week
            </button>
          )}
        </div>
      ...
      <div className="week-summary-card">
        <div className="week-summary-left">
          <span
            className="week-summary-pct"
            style={{
              color:
                pct >= 80 ? "#10b981" : pct >= 50 ? "#0bbbf5ff" : "#447aefff",
            }}
          >
            {pct}%
          </span>
          <div className="week-summary-text">
            ...
            <span className="week-summary-count">
        ...
        <div className="week-summary-bar-outer">
          <div
            className="week-summary-bar-inner"
            style={{
              width: `${pct}%`,
              background:
                pct >= 80 ? "#10b981" : pct >= 50 ? "#0bbbf5ff" : "#447aefff",
